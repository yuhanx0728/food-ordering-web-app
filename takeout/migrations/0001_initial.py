# Generated by Django 2.2 on 2019-04-24 17:12
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content_type', models.CharField(default='image/jpg', max_length=50)),
                ('vendor', models.ForeignKey(default=None, on_delete=django.db.models.deletion.PROTECT, to='takeout.VendorProfile')),
            ],
        ),
        migrations.CreateModel(
            name='Order',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.ForeignKey(default=None, on_delete=django.db.models.deletion.PROTECT, to='takeout.Order')),
                ('vendor_meal', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='takeout.VendorMeal')),
            ],
        ),
    ]
